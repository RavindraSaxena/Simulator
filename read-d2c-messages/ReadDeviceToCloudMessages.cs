...
namespace read_d2c_messages
{
    class ReadDeviceToCloudMessages
    {
        ...
        private readonly static string s_eventHubsCompatibleEndpoint = "sb://ihsuprodpnres008dednamespace.servicebus.windows.net/";

        // Event Hub-compatible name
        // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
        private readonly static string s_eventHubsCompatiblePath = "iothub-ehub-myiotdemoh-592389-923f303391";
        
        // az iot hub policy show --name iothubowner --query primaryKey --hub-name {your IoT Hub name}
        private readonly static string s_iotHubSasKey = "v2yp3hti16wXqo5yQ2AkuRFV4sYM9/rGu8JPmpFMlQI=";
